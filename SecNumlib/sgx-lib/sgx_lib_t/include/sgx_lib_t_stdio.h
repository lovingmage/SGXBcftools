...
size_t memcpy_decrypted(const void* plaintext_buffer, size_t plaintext_element_size, size_t plaintext_element_count, void* outbuffer);
...
size_t memcpy_unsealed(const void* plaintext_buffer, size_t plaintext_element_size, size_t plaintext_element_count, void* outbuffer);


#define SGX_SECURE_IO_OPERATIONS_KEY
...
#define fread fread_insecure
  ...
  #define secmemcpy_out memcpy_encrypted
  #define secmemcpy_in  memcpy_decrypted
  #else
  #define fwrite fwrite_sealed
  #define fread fread_sealed
  #define secmemcpy_out memcpy_sealed
  #define secmemcpy_in  memcpy_unsealed
  #endif
#endif
