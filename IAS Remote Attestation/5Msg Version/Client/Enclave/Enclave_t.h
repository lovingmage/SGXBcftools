...
sgx_status_t process_RA_status(sgx_ra_context_t context, uint8_t* attestationStatus, uint8_t* cmacStatus, uint8_t* p_payload, int payLen, int cryptLen, uint8_t* p_iv, uint8_t* sealedSecret);
