...
int initialize_enclave(void)
{
    ...
    ret = sgx_create_enclave(LOGISTIC_FILENAME, SGX_DEBUG_FLAG, &token, &updated, &global_eid, NULL);
...
/* OCall functions */
void ocall_logistic_sample(const char *str)
{
...
int SGX_CDECL main(int argc, char *argv[])
{
    ...
    ret = ecall_logistic_sample(global_eid, &ecall_return);
    if (ret != SGX_SUCCESS)
        abort();
